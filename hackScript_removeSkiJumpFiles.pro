...
PPOL_dir  = 'C:\Users\Jordan\FITS_data\Mimir_data\PPOL_Reduced\201611\preFlattenedBackup'
...
FOREACH file, badFilenames DO BEGIN
  ; Construct the S3 file path
  S3file = S3_dir + PATH_SEP() + file
  backupFile = backup_dir + PATH_SEP() + file
  
  ; Test if there is a file to move
  IF FILE_TEST(S3file) THEN FILE_MOVE, S3file, backupFile
